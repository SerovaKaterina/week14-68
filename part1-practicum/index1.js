...
const myFirstArray = [5,'cat', false];  // объявите переменную здесь
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.
const mySecondArray = ['Катя', 'Игорь', 'Ярослав'];
...
const myInformation = ['Екатерина', 6, 'август', 'лев'];
...
// либо сразу : countries.push('Italy', 'Spain', 'France');
...
/* либо: console.log(countries.length);
...
let russianCities2 = ['Санкт-Петербург', 'Москва', 'Екатеринбург'];
russianCities = [...russianCities2, ...russianCities];
...
function sortAndPrint(randomNumbers) {
    const sortNumbers = [...randomNumbers].sort(function(a, b){
return a - b;
});
